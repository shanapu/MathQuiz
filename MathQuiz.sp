...
public void OnPluginStart()
{
	...
	CVAR_MinimumNumber = CreateConVar("sm_MathQuiz_minimum_number", "1", "What should be the minimum number for questions ?");
	CVAR_MaximumNumber = CreateConVar("sm_MathQuiz_maximum_number", "100", "What should be the maximum number for questions ?");
	CVAR_TimeAnswer = CreateConVar("sm_MathQuiz_time_answer_questions", "10", "Time in seconds to give a answer to a question.");
	
	AutoExecConfig(true, "MathQuiz");
}
